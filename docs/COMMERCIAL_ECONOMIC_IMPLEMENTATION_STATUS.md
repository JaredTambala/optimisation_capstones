...
| Conditional cost envelopes | `capstones/CAP-001/generated/commercial/evidence/conditional_cost_envelopes.json` |
| Seller-included boundary-price audit | `capstones/CAP-001/generated/commercial/evidence/external_price_build_up.json` |
| Human-readable review | `capstones/CAP-001/generated/commercial/evidence/COMMERCIAL_ECONOMIC_REPORT.md` |
...
```bash
python capstones/CAP-001/generator/generate_commercial_data.py --check
