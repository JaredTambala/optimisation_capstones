...
- `generator/generate_planning_data.py` creates the calendar,
...
- `generator/generate_dataset_packages.py` assembles BASE and
...
`generated/planning/`. The six candidate packages and their
retained evidence are under `generated/datasets/`.
