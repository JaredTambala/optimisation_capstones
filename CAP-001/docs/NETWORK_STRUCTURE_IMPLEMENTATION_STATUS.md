...
| Purpose | Evidence |
|---|---|
| Deterministic construction | `generator/generate_network.py` |
...
| Seven generated structural tables | `generated/network/data/` |
| Seed, row-count and checksum record | `generated/network/generation_manifest.json` |
| Machine-readable depth gates | `generated/network/evidence/network_depth_scorecard.json` |
| Complete derivation witnesses | `generated/network/evidence/lineage_witnesses.json` |
| Hidden-dependency witnesses | `generated/network/evidence/dependency_witnesses.json` |
| Human-readable review | `generated/network/evidence/NETWORK_STRUCTURE_REPORT.md` |
| Code-generated network diagram | `generated/network/evidence/network_overview.mmd` |
...
```bash
python generator/generate_network.py --check
