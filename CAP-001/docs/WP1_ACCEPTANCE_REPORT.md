...
| Private control skeleton | `` | Required-directory test | Passed |
...
| Generated artefacts agree with source configuration | `generated/contracts/WP1_ARTIFACT_MANIFEST.json` and SHA-256 lineage file | `python -m tooling.build_contract_artifacts --check` | Passed |
...
network (`docs/change-notes/CAP-001_MINIATURE_FIXTURE_TOPOLOGY_CHANGE_NOTES.md`, CN-002). This
