...
CN-004 (`docs/change-notes/CAP-001_DERIVED_VALUE_RECONCILIATION_CHANGE_NOTES.md`) records the
...
CN-005 (`docs/change-notes/CAP-001_BASE_REFERENCE_BENCHMARK_CHANGE_NOTES.md`) replaces the
