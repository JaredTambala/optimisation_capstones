...
DEFAULT_OUTPUT_DIR = ROOT / "generated" / "datasets"
...
def _dataset_manifest(
    ...
    return {
        ...
        "source_package_id": dataset_id,
        "package_semantics": "COMPLETE_DATASET",
        "information_available_at_period": config["planning"]["information_available_at_period"],
        "complete_horizon_known_at_p01": config["planning"]["complete_horizon_known_at_p01"],
        "compatibility_group": "CAP-001-2027-Q1-v0.4",
